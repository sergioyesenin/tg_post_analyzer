    ...
    <div className="post-detail-page">
      ...
      {postQuery.isFetching ? (
        <QueryActivityNotice
          ...
          title={t('posts.detail.refreshingTitle', { defaultValue: '������ ����� �����������' })}
          description={t('posts.detail.refreshingDescription', { defaultValue: '������� �������� ����� �������� �� ������, ���� ������������� ����������� payload.' })}
        />
      ) : null}
      ...
      {postQuery.isError && hasPostData ? (
        <QueryActivityNotice
          ...
          title={t('posts.detail.refreshErrorTitle', { defaultValue: '�� ������� �������� ������ �����' })}
          description={t('posts.detail.refreshErrorDescription', { defaultValue: '���������� ��������� �������� ������ �������� �����.' })}
          tone="danger"
        />
      ) : null}
